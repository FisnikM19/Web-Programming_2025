...
- Read the data sent from the form (selected book, number of copies, name and address of the reader)
- Get the client's IP address
- Create a reservation by calling the placeReservation() method from the service
- Display the confirmation page with the reservation details
 */